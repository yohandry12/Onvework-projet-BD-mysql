...
db.Report.belongsTo(db.Job, { foreignKey: 'contentId', constraints: false, as: 'job' });
db.Report.belongsTo(db.User, { foreignKey: 'contentId', constraints: false, as: 'user' });
...
db.Job.hasMany(db.Recommendation, { foreignKey: 'jobId', as: 'recommendations' });
...
db.User.hasMany(db.Recommendation, { foreignKey: 'employerId', as: 'recommendationsGiven' });
db.Recommendation.belongsTo(db.User, { foreignKey: 'employerId', as: 'employer' });

// Une recommandation concerne UN SEUL utilisateur (l'employé/candidat)
db.User.hasMany(db.Recommendation, { foreignKey: 'employeeId', as: 'recommendationsReceived' });
db.Recommendation.belongsTo(db.User, { foreignKey: 'employeeId', as: 'employee' });
