...
module.exports = (sequelize) => {
    ...
    CandidateProfile.init({
        ...
        diplomas: { type: DataTypes.JSON, defaultValue: [] },
        recommendationBadge: { type: DataTypes.STRING, field: 'recommendation_badge' },
        profileViewCount: { type: DataTypes.INTEGER, defaultValue: 0, field: 'profile_view_count' }
    }, { sequelize, modelName: 'CandidateProfile', tableName: 'candidate_profiles', timestamps: false, underscored: true });
    ...
    ClientProfile.init({
        ...
        avatar: { type: DataTypes.STRING, field: 'avatar' },
        employerType: {
            type: DataTypes.ENUM("Entreprise formelle", "Startup", "Particulier", "Association", "PME"),
            allowNull: false
        }
    }, { sequelize, modelName: 'ClientProfile', tableName: 'client_profiles', timestamps: false, underscored: true });
    ...
    AdminProfile.init({
        ...
        lastName: { type: DataTypes.STRING, allowNull: false, field: 'last_name' },
        phone: DataTypes.STRING
    }, { sequelize, modelName: 'AdminProfile', tableName: 'admin_profiles', timestamps: false, underscored: true });
    ...
    User.hasOne(ClientProfile, { foreignKey: 'userId', as: 'clientProfile', onDelete: 'CASCADE' });
    ClientProfile.belongsTo(User, { foreignKey: 'userId' });
